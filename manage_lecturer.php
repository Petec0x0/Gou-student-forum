      ...
      <div class="container-fluid">
       ...
       <!--##############################-->
         <i class="bi bi-arrow-right-circle-fill" style="font-size: 25px;
            color: black; margin-left: 150px;">  Manage Lecturer</i>
               ...
               <div class="container mt-4" >
                  <table class="table table-bordered">
                     ...
                     <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="create_discussion.html" type="button" class="btn float-right btn-primary" style="color: white; border-radius:50px; margin-right: 150px;">
                           Action</a> 
                        </td>
                     </tr>
                  </table>
